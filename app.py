...
def main():
    ...
    st.markdown(
        ...
        To use input the geographical area of interest in the sidebar, and click find optimal route. Once the route is found you will be given the option to download the \
        gpx file. Try visualizing it on [caltopo](https://caltopo.com/).\
     '
    )
